"""
Django settings for sbf_be_3 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-bd5^p))lwl^(+q+v3dtixb99##wtibe-ee8smm0niz$!kc56g^')
...
WSGI_APPLICATION = 'sbf_be_3.wsgi.application'
